...
class CardServiceTest {
    ...
    void createCard_success() {
        ...
        given(flashCardRepository.save(any())).willReturn(card);
    ...
    void updateCard_success() {
        ...
        given(cardDeckRepository.findByIdAndDeletedAtIsNull(DECK_ID)).willReturn(Optional.of(mockDeck()));
        given(flashCardRepository.findByIdAndDeletedAtIsNull(CARD_ID)).willReturn(Optional.of(card));
    ...
    void getCard_notFound_throwsException() {
        given(cardDeckRepository.findByIdAndDeletedAtIsNull(DECK_ID)).willReturn(Optional.of(mockDeck()));
        given(flashCardRepository.findByIdAndDeletedAtIsNull(CARD_ID)).willReturn(Optional.empty());
