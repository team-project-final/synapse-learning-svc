...
class ReviewSessionControllerTest {
    ...
    void startSession_returns200() throws Exception {
        ...
        given(reviewSessionService.startSession(any(), any(), any())).willReturn(response);
    ...
    void getReviewQueue_returns200() throws Exception {
        ...
        given(reviewSessionService.getReviewQueue(any(), eq(DECK_ID))).willReturn(cards);
    ...
    void completeSession_returns200() throws Exception {
        ...
        given(reviewSessionService.completeSession(any(), eq(SESSION_ID))).willReturn(response);
