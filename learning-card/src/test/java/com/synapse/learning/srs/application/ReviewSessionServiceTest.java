...
class ReviewSessionServiceTest {
    ...
    void startSession_setsTotalCards() {
        ...
        given(flashCardRepository.findDueCards(eq(DECK_ID), any(), any(Pageable.class)))
                .willReturn(List.of(card1, card2));
        given(reviewSessionRepository.save(any())).willAnswer(i -> i.getArgument(0));
    ...
    void completeSession_setsStatusCompleted() {
        ...
        given(reviewSessionRepository.findByIdAndTenantId(SESSION_ID, TENANT_ID))
