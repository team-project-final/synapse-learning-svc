...
class DeckServiceTest {
    ...
    void createDeck_success() {
        ...
        given(cardDeckPort.save(any())).willReturn(deck);
        ...
        verify(cardDeckPort).save(any(CardDeck.class));
    }
    ...
    void getMyDecks_success() {
        ...
        given(cardDeckPort.findAllByUserIdAndDeletedAtIsNull(USER_ID, pageable))
    ...
    void updateDeck_success() {
        ...
        given(cardDeckPort.findByIdAndDeletedAtIsNull(DECK_ID)).willReturn(Optional.of(deck));
        given(cardDeckPort.saveAndFlush(any())).willReturn(deck);
        given(cardDeckMapper.toResponse(deck)).willReturn(response);
        ...
        verify(cardDeckPort).saveAndFlush(any());
    }
